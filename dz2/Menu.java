...
public class Menu {
    ...
    private String textAddToy2 = "Для добавления ещё одной игрушки в розыгрыш нажмите 1, для возврата в главное меню нажмите 0: ";
    private String textRemoveToy1 ="Для удаления игрушки из розыгрыша, выберите позицию из списка: 1-%d; наберите 0 для отмены и возврата в главное меню :\n";
    private String textRemoveToy2 = "Для удаления ещё одной игрушки в розыгрыш нажмите 1, для возврата в главное меню нажмите 0: ";
    ...
    public Double inputChance(){
        ...
        while (flag == false){
            try {
                System.out.print("Введите процентный шанс выпадения для данной позиции в диапазоне от 1 до 100: ");
                sample = System.console().readLine();
