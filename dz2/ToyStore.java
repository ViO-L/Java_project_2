...
public class ToyStore {
    ...
    public int changeChance(){
        //System.out.println("Изменить шанс выпадение игрушки:");
        showStorage();
        if (storage.size() == 0) {
            menu.any();
            return 0;
    ...
    public int changeAmount(){
        //System.out.println("Увеличить количество игрушек в хранилище");
        showStorage();
        if (storage.size() == 0) {
            menu.any();
            return 0;
            ...
            System.out.println("Кол-во игрушек для выбранной позиции было изменено");
            menu.any();
            return 1;
        }
    }
    ...
    public int addToRaffle(){
        ...
        while (flag == false) {
            if (storage.size() == 0) {
                ...
                //System.out.println("Выберите позицию для добавления игрушки в список для розыгрыша");
                showStorage();
                System.out.println("=========");
    ...
    public int removeFromRaffle(){
        ...
        while (flag == false) {
            if (raffle.size() == 0) {
                ...
                //System.out.println("Выберите позицию для удаления игрушки из списка розыгрыша");
                showRaffleList();
                System.out.println("=========");
    ...
    public int raffleTime(){
        if (raffle.size() == 0) {
            ...
            record = String.format("Розыгрыш завершён, кол-во разыгранных игрушек: %d\n============", toyCounter);
            dataWork.saveTxt(record);
            System.out.println(record);
            menu.any();
            return 1;
